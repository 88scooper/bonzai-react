          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  <label htmlFor="accountName" className="block text-sm font-medium mb-1 text-black dark:text-white">
                    Account Name *
                  </label>
                  <input
                    id="accountName"
                ...
                <div>
                  <label htmlFor="accountEmail" className="block text-sm font-medium mb-1 text-black dark:text-white">
                    Email *
                  </label>
                  <input
                    id="accountEmail"
